"""
Pegasus-based abstractive text summarization.
"""
...
class PegasusSummarizer(BaseAbstractiveSummarizer):
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        self.model_name = self.config.get('model_name', 'google/pegasus-xsum')
    ...
    def load_model(self):
        ...
        try:
            ...
            self.is_loaded = True
            logger.info(f"Pegasus model {self.model_name} loaded successfully on {self.device}")
            
        except Exception as e:
            logger.error(f"Error loading Pegasus model: {str(e)}")
            raise
    ...
    def _get_generation_details(self, text: str, summary: str) -> Dict[str, Any]:
        """Get Pegasus-specific generation details."""
